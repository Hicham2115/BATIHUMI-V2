...
export function CtaBanner() {
  return (
    <>
      {/* Mobile: compact card, no feature list */}
      <div className="relative isolate overflow-hidden rounded-3xl bg-blue-950 lg:hidden">
        <div className="relative aspect-4/3 w-full sm:aspect-video">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-blue-950 via-blue-950/80 to-blue-950/20" />
        </div>
        ...
        <div className="relative flex flex-col gap-4 p-6">
          ...
          <h2 className="font-heading text-2xl leading-tight font-extrabold text-white">
            Vous vendez ou achetez en{" "}
            <span className="text-blue-400">Île-de-France ?</span>
          </h2>

          <p className="text-sm text-slate-300">
            Obtenez un rapport d&rsquo;expert avant votre transaction et
            protégez-vous des vices cachés.
          </p>

          <Button
            size="lg"
            className="h-auto w-full gap-2 bg-blue-700 px-6 py-3 text-white hover:bg-blue-600"
            render={<Link href="#contact" />}
            nativeButton={false}
          >
            <ArrowRight className="size-4" />
            Demander un rapport d&rsquo;expertise
          </Button>
        </div>
      </div>

      {/* Desktop: full-bleed image with feature list */}
      <div className="relative isolate hidden overflow-hidden rounded-3xl bg-blue-950 lg:block">
        <Image
          src="/images/banner.png"
          alt="Rapport d'expertise humidité avant une transaction immobilière"
          fill
        ...
        <div className="relative flex min-h-140 max-w-2xl flex-col justify-center gap-7 p-14">
          ...
          <div>
            ...
            <div
              className="mt-4 h-1 w-16 rounded-full bg-blue-500"
              aria-hidden="true"
            />
          </div>

          <p className="max-w-xl text-slate-300">
            Un problème d&rsquo;humidité non traité peut bloquer une vente ou
            faire chuter le prix de 10 à 15%. Obtenez un rapport
            ...
            {features.map((feature) => (
              ...
              >
                ...
                <p className="pt-1.5 text-sm">
                  ...
                  {feature.description && (
                    <span className="mt-0.5 block text-blue-400">
                      {feature.description}
                    </span>
                  )}
                </p>
